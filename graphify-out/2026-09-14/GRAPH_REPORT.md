...
Cohesion: 0.06
Nodes (50): App(), AuthBranding(), AuthBrandingProps, ProtectedRoute(), Topbar(), ThemeProvider(), useTheme(), PublicLayout() (+42 more)
...
- **Why does `cn()` connect `success_response` to `cn`, `Dashboard.tsx`, `exportEventsToICS`, `assignmentService.ts`, `seed_firestore.py`, `CreateCourse.tsx`, `firebase.py`?**
