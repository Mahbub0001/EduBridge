# Graph Report - project-3  (2026-07-05)

## Corpus Check
- 154 files · ~78,356 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 811 nodes · 2253 edges · 71 communities (70 shown, 1 thin omitted)
...
6. `Button()` - 37 edges
7. `Badge()` - 26 edges
8. `useTranslation()` - 23 edges
9. `getMyInstructorCourses()` - 20 edges
10. `useAuthStore` - 19 edges
...
## Communities (71 total, 1 thin omitted)

### Community 0 - "unwrap"
Cohesion: 0.17
Nodes (24): CourseBuilder(), Step, STEPS, unwrap(), getMe(), checkCoursePublish(), createInstructorLesson(), createInstructorModule() (+16 more)
...
### Community 4 - "cn"
Cohesion: 0.05
Nodes (61): App(), AuthBranding(), AuthBrandingProps, ProtectedRoute(), defaultNavItems, NavItem, Sidebar(), SidebarProps (+53 more)

### Community 5 - "Card.tsx"
Cohesion: 0.13
Nodes (11): Button(), ButtonProps, Card(), CardProps, CertificateCard(), CertificateCardProps, InstructorHelpCenter(), features (+3 more)

### Community 6 - "Topbar.tsx"
Cohesion: 0.18
Nodes (16): PageHeader(), Topbar(), ThemeProvider(), useTheme(), PublicLayout(), PublicLayoutProps, Calendar(), Discussions() (+8 more)

### Community 7 - "Dashboard.tsx"
Cohesion: 0.13
Nodes (24): InstructorCourses(), CATEGORIES, CourseFormData, CreateCourse(), INITIAL, STEPS, Dashboard(), Skeleton() (+16 more)

### Community 8 - "App.tsx"
Cohesion: 0.15
Nodes (19): BreadcrumbItem, CourseLearning(), FlatItem, getCourseQuizzesList(), getVimeoEmbedUrl(), getYouTubeEmbedUrl(), resolveUrl(), CourseQuizzes() (+11 more)
...
Cohesion: 0.13
Nodes (19): NotificationDropdown(), NotificationDropdownProps, TopbarProps, AssignmentCard(), AssignmentCardProps, statusStyles, CalendarCard(), CalendarCardProps (+11 more)

### Community 11 - "Dashboard.tsx"
Cohesion: 0.27
Nodes (10): Assignments(), CATEGORY_COLORS, CircularProgress(), Dashboard(), timeAgo(), getAllAssignments(), getMySubmission(), submitAssignment() (+2 more)
...
Cohesion: 0.18
Nodes (19): ConfirmDialog(), ConfirmDialogProps, InstructorAnalytics(), InstructorAssignments(), RubricCriterion, InstructorSubmissions(), createAssignment(), deleteAssignment() (+11 more)
...
Cohesion: 0.17
Nodes (17): Badge(), variants, CourseCard(), CourseCardProps, AdminCourses(), CATEGORY_COLORS, MyCourses(), tabFromPath() (+9 more)
...
Cohesion: 0.30
Nodes (13): ModuleFeedback(), ModuleFeedbackProps, InstructorDiscussions(), timeAgo(), deleteDiscussionThread(), getInstructorDiscussionDetail(), getInstructorDiscussions(), getModuleDiscussion() (+5 more)
...
- **Why does `unwrap()` connect `unwrap` to `cn`, `Card.tsx`, `Topbar.tsx`, `Analytics.tsx`, `App.tsx`, `Dashboard.tsx`, `Dashboard.tsx`, `adminService.ts`, `assignmentService.ts`, `Sidebar.tsx`, `Badge.tsx`, `index.ts`, `MyCourses.tsx`, `store.ts`, `Categories.tsx`?**
